...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        //This run method will be executed FIRST BEFORE ANYTHING when we start the app
        //create some roles and put in the DB(map)
        RoleDTO adminRole = new RoleDTO(1L, "Admin");//we do not have data layer in this proj that's why we use DTO objs
        RoleDTO managerRole = new RoleDTO(2L, "Manager");
        RoleDTO employeeRole = new RoleDTO(3L, "Employee");

        /*
         saving like this make it tightly coupled
